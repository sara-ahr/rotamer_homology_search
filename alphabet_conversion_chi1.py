...
coordinates = np.load('cluster_centroids_chi1.npy', allow_pickle = True).item()
...
for f in os.listdir('/home/sarah/Downloads/pdb_torsion_angles'):
    ...
    input_file_del = input_file[['resn', 'chi1']]
    AAs = ['ARG','ASN','ASP','CYS','GLU', 'GLN','HIS','ILE','LEU','LYS','MET','PHE','PRO','SER','THR','TRP','TYR','VAL']
    ...
    name = '.'.join(name)
    name = str(name[7:])
    os.chdir('/home/sarah/Downloads/pdb_con_seqs_chi1/')
